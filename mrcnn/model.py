...
from mrcnn.backbone import mobilenet
...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        if self.backbone == "resnet101":
            ...
            _, C2, C3, C4, C5 = mobilenet.mobilenetv2_graph(input_image, 'mobilenetv2', alpha=1.0, train_bn=config.TRAIN_BN)
        elif self.backbone == "mobilenetv1":
            _, C2, C3, C4, C5 = mobilenet.mobilenetv1_graph(input_image, 'mobilenetv1', alpha=1.0, train_bn=config.TRAIN_BN)
